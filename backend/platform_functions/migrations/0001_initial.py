...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='stock_basic',
            fields=[
                ('stock_code', models.CharField(max_length=9, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_sex', models.IntegerField(choices=[(0, '男'), (1, '女')], null=True)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['stock_code', 'trade_date'], name='stock_marke_stock_c_446ffc_idx')],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_type', models.IntegerField(choices=[(0, '买入'), (1, '卖出')])),
                ...
                ('user_id', models.ForeignKey(db_column='user_id', on_delete=django.db.models.deletion.CASCADE, to='platform_functions.user_accounts')),
            ],
            options={
